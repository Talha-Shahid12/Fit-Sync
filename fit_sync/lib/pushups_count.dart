...
class pushup_count extends StatefulWidget {
  @override
  _pushup_count createState() => _pushup_count();
}

class _pushup_count extends State<pushup_count> {
  ...
  Future<void> _sendImageToBackend(Uint8List bytes) async {
    ...
    var apiUrl = 'http://192.168.36.234:3355/count_pushups';
