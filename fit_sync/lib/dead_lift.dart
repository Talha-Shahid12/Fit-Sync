...
class dead_lift extends StatefulWidget {
  @override
  _dead_lift createState() => _dead_lift();
}

class _dead_lift extends State<dead_lift> {
  ...
  Future<void> _sendImageToBackend(Uint8List bytes) async {
    ...
    var apiUrl = 'http://192.168.36.234:3355/dead-lift';
