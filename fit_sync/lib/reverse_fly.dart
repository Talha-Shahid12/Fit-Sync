...
class reverse_fly extends StatefulWidget {
  @override
  _reverse_fly createState() => _reverse_fly();
}

class _reverse_fly extends State<reverse_fly> {
  ...
  Future<void> _sendImageToBackend(Uint8List bytes) async {
    ...
    var apiUrl = 'http://192.168.36.234:3355/reverse-fly';
