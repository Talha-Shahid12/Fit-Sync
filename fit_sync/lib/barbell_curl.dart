...
class barbell_curl extends StatefulWidget {
  @override
  _barbell_curl createState() => _barbell_curl();
}

class _barbell_curl extends State<barbell_curl> {
  ...
  Future<void> _sendImageToBackend(Uint8List bytes) async {
    ...
    var apiUrl = 'http://192.168.36.234:3355/barbell-curl';
